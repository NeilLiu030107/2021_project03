...
public class Constants {
    ...
    public static class cHatchGrabber {
        public static int shoppingCartMotorPin;
        public static int shoppingCartSPXPin;
        public static int hatchSolenoidPin;
        public static int hatchGrabberPDPpin;
